...
\begin{document}
    ...
    \begin{proof}
        \pf
        \step{1}{$(1+\delta)^0 = 1 + 0 \delta$}
        \step{2}{If $(1+\delta)^n = 1 + n \delta$ then $(1+\delta)^{n+1} \geq 1 + (n+1)\delta$}
        \begin{proof}
            \pf
            \begin{align*}
    ...
    \begin{proof}
        \pf
        \step{1}{$\forall n. u^n < u^{n+1}$}
        \step{2}{For every positive $v \in D$, there exists an integer $n$ such that $u^n > 1 + v$}
        \begin{proof}
            \step{a}{\pflet{$\delta = u - 1$}}
            \step{b}{\pick\ $n$ such that $n \delta > v$}
            \step{c}{$u^n > 1 + v$}
            \begin{proof}
                \pf
                \begin{align*}
    ...
    \begin{proof}
        \pf
        \step{1}{\assume{w.l.o.g. $r \neq 0$}}
        \step{2}{\pflet{$u = 1/r$}}
        \step{3}{$(u^n)$ is a strictly increasing unbounded sequence.}
        \begin{proof}
            \pf\ Lemma \ref{lemma:un_increasing_unbounded}.
        \end{proof}
        \step{4}{\pflet{$\epsilon > 0$}}
        \step{5}{\pick\ $N$ such that $u^N > 1 / \epsilon$}
        \step{6}{$\forall n \geq N. r^n < \epsilon$}
        \qed
    \end{proof}
    ...
    \begin{proof}
        \pf
        \step{1}{\pflet{$p = |u| - 1$}}
        \step{2}{For $n > 2k+2$ we have $|u|^n > n^{k+1} p^{k+1} / 2^{k+1} (k+1)!$}
        \begin{proof}
            \pf
            \begin{align*}
                |u|^n & = (1+p)^n \\
            ...
            \end{align*}
        \end{proof}
        \step{3}{For $n > 2k$ we have $|n^k / u^n|  < (2^{k+1} (k+1)! / p^{k+1}) 1/n$}
        \step{4}{$n^k/u^n \rightarrow 0$ as $n \rightarrow \infty$}
        \qed
    \end{proof}
    ...
    \begin{proof}
        \pf
        \step{1}{\pflet{$z = a+bi$ and $w = c+di$}}
        \step{2}{$0 \leq (ad-bc)^2$}
        \step{3}{$0 \leq a^2d^2 - 2abcd + b^2c^2$}
        \step{4}{$a^2 c^2 + 2abcd + b^2 d^2 \leq a^2 c^2 + a^2 d^2 + b^2 c^2 + b^2 d^2$}
        \step{5}{$(ac+bd)^2 \leq (a^2 + b^2)(c^2 + d^2)$}
        \step{6}{$ac+bd \leq |z||w|$}
        \step{7}{$a^2 + 2ac + c^2 + b^2 + 2bd + d^2 \leq |z|^2 + |w|^2 + 2|z||w|$}
        \step{8}{$(a+c)^2 + (b+d)^2 \leq (|z|+|w|)^2$}
        \step{9}{$|z+w| \leq |z| + |w|$}
        \qed
    \end{proof}
