...
\begin{document}
    ...
    \begin{theorem}
        The relation $\sim$ on $\mathbb{Z} \times (\mathbb{Z} - \{ 0 \})$ defined by
    ...
    \begin{proof}
        \pf
        \step{1}{The relation $\sim$ is reflexive.}
        \begin{proof}
            \pf\ For any $(a,b) \in \mathbb{Z} \times (\mathbb{Z} - \{ 0 \})$,
            we have $ab = ab$.
        \end{proof}
        \step{2}{The relation $\sim$ is symmetric.}
        \begin{proof}
        ...
        \step{3}{The relation $\sim$ is transitive.}
        \begin{proof}
            \step{a}{\pflet{$(a,b),(c,d),(e,f) \in \mathbb{Z} \times (\mathbb{Z} - \{ 0 \})$}}
            \step{b}{\assume{$(a,b) \sim (c,d) \sim (e,f)$}}
            \step{c}{$ad = bc$ and $cf = de$}
            \step{d}{$adf = bcf$ and $bcf = bde$}
            \step{e}{$adf = bde$}
            \step{f}{$af = be$}
            \begin{proof}
                \pf\ Theorem \ref{theorem:integers_cancel}.
            \end{proof}
            \step{g}{$(a,b) \sim (e,f)$}
        \end{proof}
        \qed
    ...
    \begin{definition}[Rational Numbers]
        The set of \emph{rational numbers} $\mathbb{Q}$ is $\mathbb{Z} \times (\mathbb{Z} - \{ 0 \}) / \sim$.
    \end{definition}
    ...
    \begin{proof}
        ...
        \step{1}{$bd \neq 0$ and $b'd' \neq 0$}
        \begin{proof}
            \pf\ Theorem \ref{theorem:integers_no_zero_divisors}.
        \end{proof}
        \step{2}{$(ad+bc)b'd' = (a'd'+b'c')bd$}
        \begin{proof}
            \pf
            \begin{align*}
    ...
    \begin{definition}[Addition]
        \emph{Addition} $+$ is the binary operation on $\mathbb{Q}$ defined by:
    ...
    \begin{definition}
        The rational number \emph{zero} is $0 = [\langle 0,1 \rangle]$.    
    \end{definition}

    \begin{theorem}
        For any rational $q$, $q + 0 = q$.
    \end{theorem}
    ...
    \begin{theorem}
        For any rational $q$, there exists a rational $r$ such that $q + r = 0$.
    \end{theorem}

    \begin{proof}
        \pf\ If $q = [(a,b)]$, take $r = [(-a,b)]$.
    \end{proof}
    ...
    \begin{definition}[Multiplication]
        \emph{Multiplication} $\cdot$ is the operation on $\mathbb{Q}$ defined by
        $[(a,b)][(c,d)] = [(ac,bd)]$.
    \end{definition}
    ...
    \begin{definition}
        The rational number \emph{one} is $1 = [(1,1)]$.
    \end{definition}

    \begin{theorem}
        For any rational $q$ we have $q1 = q$.
    \end{theorem}
    ...
    \begin{theorem}
        For any nonzero rational $q$, there exists a nonzero rational $r$ such that $qr = 1$.
    \end{theorem}

    \begin{proof}
        \pf\ If $q = [(a,b)]$ then take $r = [(b,a)]$. We have $a \neq 0$ because $q \neq 0$. \qed
    \end{proof}

    \begin{corollary}
        For any rationals $q$ and $r$, if $qr = 0$ then $q = 0$ or $r = 0$.
    \end{corollary}
\end{document}