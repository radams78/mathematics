...
\begin{document}
    ...
    \begin{proof}
        \pf\ By Theorem \ref{theorem:subset_axiom} applied to $\mathcal{PP}(A \cup B)$. \qed
    \end{proof}
    ...
    \begin{proof}
        \pf\ Apply Theorem \ref{theorem:subset_axiom} to $\bigcup \bigcup R$. \qed
    \end{proof}
    ...
    \begin{theorem}
        \begin{enumerate}
            \item For any function $F : A \rightarrow B$, if $F$ has a right inverse then $F$ maps $A$ onto $B$.
            \item The Axiom of Choice is equivalent to the statement: for any sets $A$ and $B$
