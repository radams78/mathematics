...
\begin{document}
    ...
    \begin{definition}[Well Founded]
        A relation $R$ on a set $D$ is \emph{well-founded} iff every nonempty subset of $D$ has an
        $R$-minimal element.
    \end{definition}
    ...
    \begin{proof}
        ...
        \step{2}{\pflet{$t$ be the least element of $A - B$}}
    ...
    \begin{proof}
        ...
        iff $\dom v = \{ x \in A : x \leq t \}$ and $\forall x \in \dom v. P(v \restriction \seg x, v(x))$}
        ...
        \begin{proof}
            ...
            \step{c}{$v_1(x) = v_2(x)$}
            \begin{proof}
                \pf\ Since there is only one $y$ such that $P(v_1 \restriction \seg x, y)$.
            \end{proof}
            \qedstep
            \begin{proof}
        ...
        \begin{proof}
            ...
            \step{f}{$x = y$}
        \end{proof}
        \step{7}{$\forall x \in \dom F. P(F \restriction \seg x, F(x))$}
        \begin{proof}
            \step{a}{\pflet{$x \in \dom F$}}
            \step{b}{\pick\ $v \in \mathcal{H}$ such that $x \in \dom v$}
            \step{c}{$P(v \restriction \seg x, v(x))$}
        ...
        \begin{proof}
            ...
            \seg x, G(x))$} \prove{$\forall x \in A. F(x) = G(x)$}}
            \step{b}{\pflet{$x \in A$}}
    ...
    \begin{proof}
        \pf
        \step{1}{$\forall t \in A. E(t) \notin E(t)$}
        \begin{proof}
            \step{a}{\pflet{$t \in A$}}
            \step{b}{\assume{$\forall s < t. E(s) \notin E(s)$}}
            \step{c}{\assume{for a contradiction $E(t) \in E(t)$}}
            \step{d}{\pick\ $x < t$ such that $E(t) = E(x)$}
            \step{e}{$E(x) \in E(x)$}
            \qedstep
            \begin{proof}
                \pf\ This is a contradiction. The result follows by transfinite induction.
            \end{proof}
        \end{proof}
        \step{2}{$E$ is injective.}
        \begin{proof}
            \step{a}{\assume{for a contradiction $E(x) = E(y)$ where $x \neq y$}}
            \step{b}{\assume{w.l.o.g. $x < y$}}
            \step{c}{$E(x) \in E(y)$}
            \qedstep
            \begin{proof}
            ...
            \end{proof}
        \end{proof}
        \step{3}{$\forall s,t \in A (s < t \Leftrightarrow E(s) \in E(t))$}
        \begin{proof}
            \step{a}{\pflet{$s,t \in A$}}
            \step{b}{If $s < t$ then $E(s) \in E(t)$}
            \begin{proof}
                \pf\ Immediate from definition of $E$.
            \end{proof}
            \step{c}{If $E(s) \in E(t)$ then $s < t$}
            \begin{proof}
                \step{i}{\assume{$E(s) \in E(t)$}}
                \step{ii}{\pick\ $x < t$ such that $E(s) = E(x)$}
                \step{iii}{$s = x$}
                \begin{proof}
                    \pf\ \stepref{2}.
                \end{proof}
            ...
            \end{proof}
        \end{proof}
        \step{4}{$\alpha$ is a transitive set.}
        \begin{proof}
            \pf\ From definition of $E$.
        \end{proof}
    \end{proof}
    ...
    \begin{proof}
        ...
        \step{2}{If $A$ and $B$ have the same $\epsilon$-image then they are isomorphic.}
        \begin{proof}
            \pf\ From Corollary \ref{corollary:isomorphic_to_epsilon_image}.
        \end{proof}
        \step{3}{If $A \cong B$ then $A$ and $B$ have the same epsilon-image.}
        \begin{proof}
            \step{a}{\pflet{$f : A \cong B$}}
            \step{b}{\pflet{$E : A \cong \alpha$ and $F : B \cong \beta$ be the canonical isomorphisms
            between $A$ and $B$ and their epsilon-images.}}
            \step{c}{$\forall x \in A. E(x) = F(f(x))$}
            \begin{proof}
                \step{i}{\pflet{$x \in A$}}
                \step{ii}{\assume{$\forall y < x. E(y) = F(f(y))$}}
                \step{iii}{$E(x) = F(f(x))$}
                \begin{proof}
                    \pf
                    \begin{align*}
    ...
    \begin{theorem}[Well-Ordering Theorem (Choice)]
        For any set $A$, there exists a well ordering on $A$.
    \end{theorem}
    ...
    \begin{proof}
        ...
        \step{3}{$A \preccurlyeq \alpha$}
        \step{4}{\pick\ an injection $f : A \rightarrow \alpha$}
        \step{5}{Define $<$ on $A$ by: $x < y$ iff $f(x) \in f(y)$}
        \step{6}{$<$ is a well ordering on $A$.}
        \qed
    \end{proof}
    ...
    \begin{proof}
        \pf
        \step{1}{If $<$ is a well-ordering on $A$ then there does not exist any function $f : \omega
        \rightarrow \omega$ such that $f(n+1) < f(n)$ for all $n \in \omega$.}
        \begin{proof}
            \pf\ If there is such a function $f$ then $\ran f$ is a nonempty subset of $A$ with no least
            element.
        \end{proof}
        \step{2}{If there does not exist any function $f : \omega \rightarrow A$ such that $f(n+1)
        < f(n)$ for all $n \in \omega$ then $<$ is a well-ordering on $A$.}
        \begin{proof}
            \step{a}{\pflet{$X \subseteq A$ be a nonempty subset of $A$ with no least element.}
            \prove{There exists a function $f : \omega \rightarrow A$ such that
            $f(n+1) < f(n)$ for all $n \in \omega$}}
            \step{b}{\pick\ $a_0 \in X$}
            \step{c}{$\forall x \in X. \exists y \in X. y < x$}
            \step{d}{\pick\ a function $g : X \rightarrow X$ such that $\forall x \in X. g(x) < x$}
            \begin{proof}
                \pf\ By the Axiom of Choice.
            \end{proof}
            ...
            \begin{align*}
                ...
                f(n^+) & = g(f(n))
            \end{align*}}
            \step{f}{$\forall n \in \omega. f(n^+) < f(n)$}
        \end{proof}
        \qed
    \end{proof}
